...
Model_run() {
    ...
    deepspeed --include "localhost:$include" \
        --master_port $port $1 \
        --deepspeed $code_dir/configs/ds_config_zero2.json \
        --model_path $base_dir/output/tf_sft_04051644/model/checkpoint-38419 \
        --data_path /ceph2/yy/note/myllama/data/other \
        --cache True \
        --do_train True \
        --do_eval False \
        --bf16 True \
